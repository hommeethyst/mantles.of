...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Tops',
    price: 'Rp 1.550.000',
    slug: 'padded-angel-baby-hoodie-blue',
    color: 'Baby Blue',
    desc: 'Heavyweight hoodie in baby blue with unique padded detailing and a soft-touch finish.',
    features: [
      'Padded architectural details',
      'Heavyweight premium fleece',
      'Signature Angel silhouette',
    ],
    images: ['/hoodieblue.png'],
  },
  {
    id: 7,
    name: 'Padded Angel Baby Hoodie',
    ...
    color: 'Butter',
    desc: 'Creamy butter-toned heavyweight hoodie featuring tonal padded accents and oversized hood.',
    features: [
      'Tonal padded accents',
      'Premium heavyweight cotton',
      'Oversized comfort hood',
    ],
    images: ['/hoodiebutter.png'],
  },
]
